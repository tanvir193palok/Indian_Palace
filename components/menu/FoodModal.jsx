  ...
  return (
    <div className="relative w-full max-w-[90%] md:max-w-[35%] lg:h-[90%] h-auto px-2 lg:px-6 pt-2 lg:pt-4 pb-3 lg:pb-6 rounded-lg lg:rounded-xl bg-white overflow-y-auto">
      ...
      <button
        ...
        className="absolute top-3 lg:top-5 right-3 lg:right-6 flex items-center justify-center text-[24px] lg:text-[30px] border-2 px-2 py-1 rounded-full bg-text text-white hover:bg-transparent hover:text-text"
      >
      ...
      <textarea
        rows="2"
        className="w-full text-start mt-1 mb-2 lg:mb-4 py-3 px-2 rounded-lg border border-gray-300 text-gray-600 text-xs lg:text-sm placeholder-gray-400 focus:border-nav focus:ring-0 appearance-none focus:outline-none resize-none"
